...
def check_int(spam=None):
    ...
    Hence, to raise the assert for any numbers less than 10,
    we have to enforce the number to be greater than 10.

    """
    assert int(spam) > 10, "Integer value less than 10"
